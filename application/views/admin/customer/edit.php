        ...
        <script type="text/javascript">  
          $(document).ready(function() {  
                     ...
                     /*dropdown post *///  
                     $.ajax({  
                        url:"<?php echo base_url('admin/customer/ajax_ciudad');?>",  
                        data: {id: $(this).val()},  
                        type: "POST",  
        ...
        <script type="text/javascript">  
          $(document).ready(function() {  
                     ...
                     /*dropdown post *///  
                     $.ajax({  
                        url:"<?php echo base_url('admin/customer/ajax_comunas');?>",  
                        data: {id: $(this).val()},  
                        type: "POST",  
                        success:function(data){  
                        $("#comuna").html(data);  
...
<?php
  $rut = array('maxlength' => '20', 'name' => 'rut', 'id' => 'rut', 'class' => 'form-control col-md-7 col-xs-12', 'placeholder' => 'Ingresar rut', 'autofocus' => 'autofocus', 'value' => my_rut_formato($customer->rut) ); 
  $name = array('maxlength' => '100', 'name' => 'name', 'id' => 'name', 'class' => 'form-control', 'placeholder' => 'Ingresar nombre', 'value' => $customer->name ); 
  $ap_pat = array('maxlength' => '100', 'name' => 'ap_paterno', 'id' => 'ap_paterno', 'class' => 'form-control', 'placeholder' => 'Ingresar apellido', 'value' => $customer->ap_paterno ); 
  $ap_mat = array('maxlength' => '100', 'name' => 'ap_materno', 'id' => 'ap_materno', 'class' => 'form-control', 'placeholder' => 'Ingresar apellido', 'value' => $customer->ap_materno ); 
  $direccion = array('maxlength' => '50', 'name'  => 'direccion', 'id' => 'direccion', 'class' => 'form-control', 'placeholder' => 'Ingresar dirección', 'value' => $customer->direccion ); 
  $phone_f = array('maxlength' => '9', 'name' => 'phone_f', 'id' => 'phone_f', 'class' => 'form-control', 'placeholder' => '632202155', 'value' => $customer->phone_f ); 
  $phone_m = array('maxlength' => '9', 'name' => 'phone_m', 'id' => 'phone_m', 'class' => 'form-control', 'placeholder' => '915309157', 'value' => $customer->phone_m ); 
  $email = array('maxlength' => '100', 'type' => 'email', 'name'  => 'email', 'id' => 'email', 'class' => 'form-control', 'placeholder' => 'Ingresar e-mail cliente', 'value' => $customer->email ); 
                  ...
                  <div class="x_content">
                    ...
                    <?= form_open_multipart('admin/customer/insert', array("class"=>"form-horizontal form-label-left","id"=>"demo-form2","data-parsley-validate")); ?>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <?= form_dropdown('region' ,$dropdown_list_region, $customer->region_id,'class="form-control col-md-7 col-xs-12" id="region"');?>
                        </div>
                      </div>
                      <div class="form-group">
                        <?= form_label('Ciudad <span class="required">*</span>', 'ciudad',array('class'=>'control-label col-md-3 col-sm-3 col-xs-12')); ?>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <?= form_dropdown('ciudad' ,$dropdown_list_ciudad, $customer->ciudad_id,'class="form-control col-md-7 col-xs-12" id="ciudad"');?>
                        </div>
                      </div> 
                      <div class="form-group">
                        <?= form_label('Comuna <span class="required">*</span>', 'comuna',array('class'=>'control-label col-md-3 col-sm-3 col-xs-12')); ?>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <?= form_dropdown('comuna' ,$dropdown_list_comuna, $customer->comuna_id,'class="form-control col-md-7 col-xs-12" id="comuna"');?>
                        </div>
                      </div>                       
                      <div class="form-group">
                        <?= form_label('Actividad comercial <span class="required">*</span>', 'actividad',array('class'=>'control-label col-md-3 col-sm-3 col-xs-12')); ?>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <?= form_dropdown('actividad' ,$dropdown_list_activity, $customer->activity_type_id,'class="form-control col-md-7 col-xs-12" id="actividad"');?>
                        </div>
                      </div> 
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <?= anchor('admin/customer/view','<i class="glyphicon glyphicon-arrow-left"></i> Volver',array('class'=>'btn btn-info')); ?>
                          <?= form_button( $submit ); ?>
                        </div>
                      </div>
                    <?=form_close();?>
