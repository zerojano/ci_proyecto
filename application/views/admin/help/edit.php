<?php
  $rut = array('maxlength' => '20', 'name' => 'rut', 'id' => 'rut', 'class' => 'form-control col-md-7 col-xs-12', 'placeholder' => 'Ingresar rut', 'autofocus' => 'autofocus', 'value' => $user->rut );
  $username = array('maxlength' => '20', 'name' => 'username', 'id' => 'username', 'class' => 'form-control col-md-7 col-xs-12', 'placeholder' => 'Ingresar nombre de usuario', 'value' => $user->username );   
  $nombre = array('maxlength' => '100', 'name' => 'nombre', 'id' => 'nombre', 'class' => 'form-control col-md-7 col-xs-12', 'placeholder' => 'Ingresar nombre', 'value' => $user->nombre ); 
  $apellidos = array('maxlength' => '100', 'name' => 'apellido', 'id' => 'apellido', 'class' => 'form-control col-md-7 col-xs-12', 'placeholder' => 'Ingresar apellidos', 'value' => $user->apellidos ); 
  ...
  $email = array('maxlength' => '100', 'type' => 'email', 'name'  => 'email', 'id' => 'email', 'class' => 'form-control col-md-7 col-xs-12', 'placeholder' => 'Ingresar e-mail usuario', 'value' => $user->email ); 
