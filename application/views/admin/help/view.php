                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo $query->apellidos;  ?></td>
                    ...
                    <div class="form-group">
						<?=anchor('admin/user/create','<i class="glyphicon glyphicon-edit"></i> Nuevo usuario',array('class' => 'btn btn-success','title' => 'Nuevo usuario'));?> 
                    </div>
                  </div>
                </div>
              </div>
